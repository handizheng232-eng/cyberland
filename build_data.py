...
"forecast_unit": "万吨 dmt（实际品位 ~5.2% SC；FY27 指引 1,030-1,100kt 对应）",
    ...
    },
    {
        ...
        "fc_2027": [
            ...
            {"label": "基准", "val": 75, "note": "三线满产 + Stage 4 按时供矿——SC6 折算 69 万吨（原 750ktpa SC5.5% 精矿铭牌 75 万吨 dmt ×0.92，官方 FY25 SC6/dmt 比例）"},
    ...
    },
    {
        ...
        "fc_2027": [
            ...
            {"label": "基准", "val": 65.6, "note": "存量 DMS 满产 SC6 折算 45.9 万吨（原 65.6 万吨 dmt ×0.70，FY25 官方 SC6/dmt 比例；FY26 销量 242k SC6 为 MRL 51% 承购口径）——删浮选贡献（FID 装机 500→600ktpa SC6、调试爬坡 2H FY28 即 2028H1，不计入 2027）"},
