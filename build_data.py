...
MINES = [
    {
        ...
        "history_labels": [
            ...
            ("tech_grade", "技术级精矿产量（万吨，技术级 4 种产品 5-7.2% Li₂O（SLR 报告）；官方未单独披露逐季品位）"),
            ("chem_grade", "化学级精矿产量（万吨，SC6.0 即 6% Li₂O）"),
        ...
        "forecast_2027": {
            ...
            "scenarios": {
                ...
                "base": {
                    ...
                    "production_kt": 1780,
                    "note": "CGP3 2027 年初爬至 ~85% 利用率、年中满产；线性序列 27Q1/27Q2=41.25（FY27 指引期）+ 27Q3/27Q4 线性延至官网满产 50（2.0 Mtpa÷4）→ 2027 基准 ≈ 178.5 万吨（页面统一值，2026-08-12 满产口径调整）。"
            ...
            "quarterly_base": {
                ...
                "27Q4": 50,
                "total": 178.1
            },   # 2026-08-12 满产口径调整：27Q4=官网满产 50
            ...
            "items": [
                ...
                },
                {
                    ...
                    "sources": [
                        ...
                        {"src": "IGO 官网（2026-08 原文）", "data": "CGP3 processing capacity 2.4Mtpa → producing up to 500,000tpa of lithium mineral concentrate；first ore processed December 2025"},
                ...
                },
                {
                    ...
                    "sources": [
                        ...
                        {"src": "IGO 年报 2023", "data": "'~2.5Mtpa by FY27'——该口径 = 含 CGP4 潜在产能（2.0+0.5=2.5，与天齐 CP Report 2022 图一致）；2026 年中 CGP4 FID 未做、SLR 按无 CGP4 处理"},
                        {"src": "SLR 技术报告 (2026-02, EX-96.1)", "data": "原文：CGP3 投产后精矿年产能 1.8 to 2.0 Mtpa；2025 实际：5.85 Mtpa 矿石 → ~1.4 Mtpa SC6.0"}
                    ],
                    "status": "warn"
                }
            ],
...
LIN = {
    "history": {"A": 38.7, "B": 41.25, "cap": 50},   # GB：26Q2=38.7 → FY27 指引中值 165/4=41.25 → 官网满产 50（2.0 Mtpa÷4，存量 1.5+CGP3 0.5；2026-08-12 用户要求基于官网口径）
...
FC27 = {
    "history":         {"bear": 164, "base": 178, "bull": 195, "q": [41.25, 41.25, 45.6, 50]},   # 2026-08-12 满产口径调整：官网 2.0 Mtpa → 季均 50；基准 27Q3=45.6 线性延至 27Q4=50；乐观 27Q1=45 起快速满产
...
FC_BASIS = {
    "Greenbushes": {
        "basis": "FY27 官方指引 155-175 万吨（中值 165）→ 季均 41.25；26Q2 实际 38.7 万吨（CGP3 火灾后复产爬坡中）→ 按线性增长 26Q3E=40.0、26Q4E=41.25（等差 d=1.28）；27Q1/27Q2=41.25（FY27 指引期）、27Q3/27Q4 线性延至官网满产 50（2.0 Mtpa÷4，存量 1.5+CGP3 0.5）；2027 基准≈178 万吨（线性覆写口径，页面统一值——2026-08-12 满产口径调整）。",
