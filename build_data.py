...
"forecast_unit": "万吨 SC6（6% Li₂O 折算；IGO FY27 指引 155-175 万吨对应）",
    ...
    },
    {
        ...
        "grade_series": {"2025Q2": 5.1, "2025Q3": 5.3, "2025Q4": 5.2, "2026Q1": 5.3, "2026Q2": 5.3},   # 逐季品位（2026-08-11 机制：PLS Jun2026 QAR 附表 grade produced——列序 [Jun-25, Sep-25, Dec-25, Mar-26, Jun-26] = 5.1/5.3/5.2/5.3/5.3；其余季度未披露按统一 5.3%）（用户规范 2026-08-11：产量/销量描述必须明确品位）
